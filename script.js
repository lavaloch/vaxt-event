let space5 = document.querySelector("#Group-5");
let space6 = document.querySelector("#Group-6");
let space7 = document.querySelector("#Group-7");
let space8 = document.querySelector("#Group-8");
let space9 = document.querySelector("#Group-9");
let space10 = document.querySelector("#Group-10");
let space11 = document.querySelector("#Group-11");
let space12 = document.querySelector("#Group-12");
let space13 = document.querySelector("#Group-13");
let space14 = document.querySelector("#Group-14");
let space15 = document.querySelector("#Group-15");
...
let letterO = document.querySelector("#letter_o");
